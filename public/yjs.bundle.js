(() => {
    ...
    "node_modules/codemirror/lib/codemirror.js"(exports, module) {
      (function(global2, factory) {
        ...
        function measureCharInner(cm, prepared, ch, bias) {
          ...
          var rtop2 = rect.top - prepared.rect.top, rbot = rect.bottom - prepared.rect.top;
          var mid = (rtop2 + rbot) / 2;
        ...
        function restoreSelection(snapshot2) {
          if (!snapshot2 || !snapshot2.activeElt || snapshot2.activeElt == activeElt(snapshot2.activeElt.ownerDocument)) {
            return;
          }
  ...
  var equalityFlat = (a, b) => a === b || a != null && b != null && a.constructor === b.constructor && (a instanceof Array && equalFlat(a, b) || typeof a === "object" && equalFlat2(a, b));
  ...
  var rtop = (request) => create3((resolve, reject) => {
    request.onerror = (event) => reject(new Error(event.target.error));
    request.onblocked = () => location.reload();
    request.onsuccess = (event) => resolve(event.target.result);
  });
  var openDB = (name, initDB) => create3((resolve, reject) => {
    const request = indexedDB.open(name);
    request.onupgradeneeded = (event) => initDB(event.target.result);
    request.onerror = (event) => reject(create4(event.target.error));
    request.onblocked = () => location.reload();
  ...
  var iterateOnRequest = (request, f) => create3((resolve, reject) => {
...
${reason}`);
  ...
  Object.assign(window, { Y: yjs_exports, IndexeddbPersistence, WebsocketProvider, CodemirrorBinding, CodeMirror: import_codemirror2.default });
})();
